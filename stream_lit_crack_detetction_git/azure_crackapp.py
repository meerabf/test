...
# Main driver
st.sidebar.image("/Users/meerajoseph/Desktop/stream_lit_crack_detetction/crack_detetctive.jpg", use_column_width=True)
menu = ["Image","Imageurl"]
...
if choice == "Image":
    ...
    if classify:
        ...
        if label == "Crack found with a confidence score of " + str(prediction[0][0]*100)+ "%":        
            ### gif from local file
            file_ = open("/Users/meerajoseph/Desktop/stream_lit_crack_detetction/crack.gif", "rb")
            contents = file_.read()
            ...
            ### gif from local file
            file_ = open("/Users/meerajoseph/Desktop/stream_lit_crack_detetction/no_crack.gif", "rb")
            contents = file_.read()
            data_url = base64.b64encode(contents).decode("utf-8")
            file_.close()
            st.markdown(f'<img src="data:image/gif;base64,{data_url}" alt="cat gif">',unsafe_allow_html=True,)
